...
class Brief(Base):
    ...
    content: Mapped[str] = mapped_column(Text, default="", comment="简报Markdown内容")
    note: Mapped[str] = mapped_column(Text, default="", comment="配套便签")
    source: Mapped[str] = mapped_column(String(10), default="自主", comment="简报来源(自主/外部)")
